...
describe CheckListDefinitionsController do
  ...
  # CheckListDefinitionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested check_list_definition as @check_list_definition" do
      check_list_definition = CheckListDefinition.create! valid_attributes
      get :show, {:id => check_list_definition.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested check_list_definition as @check_list_definition" do
      check_list_definition = CheckListDefinition.create! valid_attributes
      get :edit, {:id => check_list_definition.to_param}, valid_session
      assigns(:check_list_definition).should eq(check_list_definition)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new CheckListDefinition" do
        expect {
          post :create, {:check_list_definition => valid_attributes}, valid_session
      ...
      it "redirects to the created check_list_definition" do
        post :create, {:check_list_definition => valid_attributes}, valid_session
        response.should redirect_to(CheckListDefinition.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved check_list_definition as @check_list_definition" do
        ...
        post :create, {:check_list_definition => { "name" => "invalid value" }}, valid_session
        assigns(:check_list_definition).should be_a_new(CheckListDefinition)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested check_list_definition" do
        check_list_definition = CheckListDefinition.create! valid_attributes
        # Assuming there are no other check_list_definitions in the database, this
        # specifies that the CheckListDefinition created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        CheckListDefinition.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => check_list_definition.to_param, :check_list_definition => { "name" => "MyString" }}, valid_session
      end

      it "assigns the requested check_list_definition as @check_list_definition" do
        check_list_definition = CheckListDefinition.create! valid_attributes
        put :update, {:id => check_list_definition.to_param, :check_list_definition => valid_attributes}, valid_session
        assigns(:check_list_definition).should eq(check_list_definition)
      end

      it "redirects to the check_list_definition" do
        check_list_definition = CheckListDefinition.create! valid_attributes
        put :update, {:id => check_list_definition.to_param, :check_list_definition => valid_attributes}, valid_session
        response.should redirect_to(check_list_definition)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the check_list_definition as @check_list_definition" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        CheckListDefinition.any_instance.stub(:save).and_return(false)
        put :update, {:id => check_list_definition.to_param, :check_list_definition => { "name" => "invalid value" }}, valid_session
        assigns(:check_list_definition).should eq(check_list_definition)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested check_list_definition" do
      check_list_definition = CheckListDefinition.create! valid_attributes
      expect {
        delete :destroy, {:id => check_list_definition.to_param}, valid_session
      }.to change(CheckListDefinition, :count).by(-1)
    end
